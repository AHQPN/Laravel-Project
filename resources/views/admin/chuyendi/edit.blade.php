        ...
        <div class="card-body">
            <form action="{{ route('admin.chuyendi.update', $chuyendi->machuyendi) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="machuyendi" class="form-label">Mã chuyến đi</label>
                            <input type="text" class="form-control" id="machuyendi" value="{{ $chuyendi->machuyendi }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label for="tenchuyen" class="form-label">Tên chuyến <span class="text-danger">*</span></label>
                            <input type="text" class="form-control @error('tenchuyen') is-invalid @enderror" id="tenchuyen" name="tenchuyen" value="{{ old('tenchuyen', $chuyendi->tenchuyen) }}" required>
                            @error('tenchuyen')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('maxe') is-invalid @enderror" id="maxe" name="maxe" required>
                                ...
                                @foreach($xes as $x)
                                    <option value="{{ $x->maxe }}" {{ old('maxe', $chuyendi->maxe) == $x->maxe ? 'selected' : '' }}>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('thoigiandi') is-invalid @enderror" id="thoigiandi" name="thoigiandi" value="{{ old('thoigiandi', date('Y-m-d\TH:i', strtotime($chuyendi->thoigiandi))) }}" required>
                            @error('thoigiandi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('thoigiandichuyen') is-invalid @enderror" id="thoigiandichuyen" name="thoigiandichuyen" value="{{ old('thoigiandichuyen', $chuyendi->thoigiandichuyen) }}" min="1" required>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('gia') is-invalid @enderror" id="gia" name="gia" value="{{ old('gia', $chuyendi->gia) }}" min="0" step="1000" required>
                            @error('gia')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div id="lotrinh-container">
                    @foreach($chuyendi->lotrinhs as $index => $lt)
                        ...
                        <div class="col-md-10">
                            ...
                            <select class="form-select" name="lotrinh[]" required>
                                ...
                                @foreach($tinhThanhs as $tt)
                                    <option value="{{ $tt->matinh }}" {{ $lt->matinh == $tt->matinh ? 'selected' : '' }}>{{ $tt->ten }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-2">
